        ...
        <section class="preferences-dialog__section">
          ...
          <div class="preferences-dialog__section-content">
            ...
            <label class="preferences-dialog__checkbox">
              <span><strong>Compact cards</strong><small>Hide descriptions and show more Skills in the grid.</small></span>
          ...
          <div class="preferences-dialog__section-content">
            <div class="preferences-dialog__field">
              ...
              <div class="preferences-dialog__segmented" role="radiogroup" aria-label="Installation scope">
                <button type="button" class="preferences-dialog__segment" :class="{ 'is-active': preferences.defaultScope === 'project' }" @click="emit('update', { defaultScope: 'project' })">Project</button>
                <button type="button" class="preferences-dialog__segment" :class="{ 'is-active': preferences.defaultScope === 'global' }" @click="emit('update', { defaultScope: 'global' })">Global</button>
              </div>
            </div>
            <div class="preferences-dialog__checks">
              <label class="preferences-dialog__checkbox"><span><strong>Copy instead of link</strong><small>Create independent copies of Skill files.</small></span><input type="checkbox" :checked="preferences.copyByDefault" @change="handleCopyChange" /></label>
              <label class="preferences-dialog__checkbox"><span><strong>Confirm before installation</strong><small>Review the selected Skills before commands run.</small></span><input type="checkbox" :checked="preferences.confirmBeforeInstall" @change="handleConfirmChange" /></label>
              <label class="preferences-dialog__checkbox"><span><strong>Continue after failure</strong><small>Keep installing remaining Skills when one fails.</small></span><input type="checkbox" :checked="preferences.continueAfterFailure" @change="handleContinueChange" /></label>
            </div>
          </div>
        </section>
        ...
        <section class="preferences-dialog__section">
          ...
          <div class="preferences-dialog__section-content">
            <div class="preferences-dialog__field">
              ...
              <span class="preferences-dialog__help">This is a source of installable Skills, not an installation destination.</span>
              <input id="local-skill-source" v-model="localSource" class="preferences-dialog__input" type="text" placeholder="~/.control/skill" />
        ...
        <section class="preferences-dialog__section">
          ...
          <div class="preferences-dialog__section-content preferences-dialog__tools">
            <div class="preferences-dialog__field preferences-dialog__tool">
              ...
              <span class="preferences-dialog__help">Create <code>~/.local/bin/skills</code> and open this app from the terminal's current folder.</span>
              <button type="button" class="preferences-dialog__cli-button" @click="emit('installCli')">Install <code>skills</code> command</button>
            </div>
            <div class="preferences-dialog__field preferences-dialog__tool">
...
function handleCompactCardsChange(event: Event) {
  emit('update', { compactCards: (event.target as HTMLInputElement).checked })
}
