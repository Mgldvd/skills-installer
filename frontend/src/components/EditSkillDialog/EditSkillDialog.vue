    ...
    <form v-if="skill" class="edit-skill-dialog__form" @submit.prevent="handleSubmit">
      <section class="edit-skill-dialog__hero">
        <div class="edit-skill-dialog__hero-heading">
          <div>
            ...
            <h2 class="edit-skill-dialog__title">{{ displayName || skill.displayName }}</h2>
          </div>
        ...
        <p class="edit-skill-dialog__description">{{ description || 'No description provided.' }}</p>
        <div class="edit-skill-dialog__meta">
          <span>{{ skill.local ? 'Local Skill' : `${skill.repository || 'Remote repository'} / ${skill.skillName}` }}</span>
      ...
      <section class="edit-skill-dialog__details">
        <div class="edit-skill-dialog__fields">
          ...
          <p v-if="urlError" class="edit-skill-dialog__error edit-skill-dialog__field--wide" role="alert">{{ urlError }}</p>
          ...
          <label class="edit-skill-dialog__field">
            ...
            <textarea v-model="description" class="edit-skill-dialog__input edit-skill-dialog__textarea" rows="3" maxlength="320" />
      ...
      <div class="edit-skill-dialog__actions">
        <template v-if="deleteRequested">
          ...
          <button type="button" class="edit-skill-dialog__btn edit-skill-dialog__btn--danger" @click="confirmDelete">Delete Skill</button>
        </template>
        <template v-else>
          <button type="button" class="edit-skill-dialog__btn edit-skill-dialog__btn--delete" @click="deleteRequested = true">Delete Skill</button>
