        ...
        <form v-if="skill" class="edit-skill-dialog__form" @submit.prevent="handleSubmit">
                ...
                <div class="edit-skill-dialog__meta">
                    <span>
                        {{
                            skill.local
                                ? "Local Skill"
                                : `${skill.repository || "Remote repository"} / ${skill.skillName}`
                        }}
                    </span>
            ...
            <div class="edit-skill-dialog__actions">
                <template v-if="deleteRequested">
                    <button type="button" class="edit-skill-dialog__btn" @click="deleteRequested = false">
                        Keep Skill
                    </button>
                    <button
                        type="button"
                        class="edit-skill-dialog__btn edit-skill-dialog__btn--danger"
                        @click="confirmDelete">
                        Delete Skill
                    </button>
                </template>
                <template v-else>
                    ...
                    <button
                        type="submit"
                        class="edit-skill-dialog__btn edit-skill-dialog__btn--primary"
                        :disabled="!canSubmit">
                        Save Changes
                    </button>
                </template>
